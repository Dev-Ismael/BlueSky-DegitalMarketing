<template>
    ...
    <div class="home-page">
        ...
        <section class="hero-equal-height ptb-70">
            ...
            <!-- <img src="digimark_template/img/cta-2-path-shape.png" alt="group shape" class="img-fluid group-shape-1">
            ...
            <img src="digimark_template/img/cta-2-tringle-shape.png" alt="group shape" class="img-fluid group-shape-4"> -->
            <div class="container">
            ...
            <div class="row m-0">
                <div class="col-lg-6 col-md-12 p-0">
                    <div class="free-trial-image text-center">
                        <img src="digimark_template/img/cta-2-girl-img.jpg" alt="image" class="img-fluid">
