<template>
    ...
    <div class="service-page">
        ...
        <section class="hero-section ptb-100 gradient-overlay"
            style="background: url('digimark_template/img/header-bg-5.jpg')no-repeat center center / cover">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-7">
                        <div class="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
                            <h1 class="text-white mb-0"> <i class="fa-solid fa-circle-info"></i> Services </h1>
                                ...
                                <div class="row mt-5">
                                    ...
                                    <div class="col-md-6">
                                        <ul class="list-unstyled tech-feature-list">
                                            <li class="py-1 pb-3">Completely anembrace multifunctional scenarios without
                                                orthogonal benefits.
                                                Competently the enhance equity invested data with performance based niches:
                                            </li>
                                            <li class="py-1"><span
                                                    class="ti-check-box mr-2 color-secondary"></span><strong>Foreclosure</strong>
                                            ...
                                            <li class="py-1"><span
                                                ...
                                                Optimization consultant</li>
                                            <li class="py-1"><span
                                                    class="ti-check-box mr-2 color-secondary"></span><strong>Rapidiously</strong>
                                                conceptualize communities</li>
                                            <li class="py-1"><span
                                                    class="ti-check-box mr-2 color-secondary"></span><strong>Consultant</strong>
                                                pharmacist Creative consultant
                                            </li>
                                            <li class="py-1"><span
                                                    class="ti-check-box mr-2 color-secondary"></span><strong>Monotonectally</strong>
                                ...
                                <div id="accordion-1" class="accordion accordion-faq mt-5">
                                    ...
                                    <div class="card">
                                        <div class="card-header py-3 collapsed" id="heading-1-1" data-toggle="collapse"
                                            ...
                                            <h6 class="mb-0"><span class="ti-receipt mr-3"></span> Which license do I need?
                                            </h6>
                                        </div>
                                        <div id="collapse-1-1" class="collapse" aria-labelledby="heading-1-1"
                                            ...
                                            <div class="card-body">
                                                <p>Uniquely leverage other's distinctive infomediaries rather than leveraged
                                                    supply chains. Continually seize distributed collaboration and idea-sharing
                                                    whereas user.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        <div class="card-header py-3" id="heading-1-2" data-toggle="collapse" role="button"
                                            ...
                                            <h6 class="mb-0"><span class="ti-gallery mr-3"></span> How do I get access to a
                                                theme?</h6>
                                        </div>
                                        ...
                                        <div id="collapse-1-3" class="collapse" aria-labelledby="heading-1-3"
                                            ...
                                            <div class="card-body">
                                                <p>Proactively monetize long-term high-impact innovation and scalable
                                                    relationships. Dynamically mesh principle-centered functionalities before
                                                    next-generation best practices. Distinctively empower.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
